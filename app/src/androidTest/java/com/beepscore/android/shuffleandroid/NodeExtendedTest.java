...
public class NodeExtendedTest extends TestCase {
    ...
    public void testNodeExtendedToStringPropertiesNull() {
        NodeExtended node = new NodeExtended();
        String expected = "null, indexes: [null, null], children: [null, null], didVisitLeft:null, didVisitRight:null";
    ...
    public void testNodeExtendedProperties() {
        ...
        String expectedDescription = "Joe, indexes: [null, null], children: [null, null], didVisitLeft:null, didVisitRight:null";
        ...
        expectedDescription = "Joe, indexes: [null, null], children: [Larry, null], didVisitLeft:null, didVisitRight:null";
        assertEquals(expectedDescription, joe.toString());
        ...
        rick.value = "Rick";
        expectedDescription = "Joe, indexes: [null, null], children: [Larry, Rick], didVisitLeft:null, didVisitRight:null";
        assertEquals(expectedDescription, joe.toString());
    }
